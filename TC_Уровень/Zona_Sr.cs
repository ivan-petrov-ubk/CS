...
{
    [TradeSystem("Zona_Sr")] //copy of "Zona1"
    public class Zona1 : TradeSystem
    {
		...
		if(D10>0  && Bars.Range.To==(D1+srD)) Trade.OpenMarketPosition(Instrument.Id, ExecutionRule.Sell, 0.1, Instrument.Ask, -1, Stops.InPips(150,100), null, null);
        if(U10>0  && Bars.Range.To==(U1+srU)) Trade.OpenMarketPosition(Instrument.Id, ExecutionRule.Buy, 0.1, Instrument.Bid, -1, Stops.InPips(150,100), null, null);			
