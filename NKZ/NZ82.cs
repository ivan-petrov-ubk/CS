...
XXPrint("U ИТОРИЯ- {0} - frU1={1} frU2={2} frU3={3} frD1={4} frD2={5} frD3={6}", Bars[Bars.Range.To-frac-i].Time,frU1,frU2,frU3,frD1,frD2,frD3);
				  }
...
XXPrint("D ИСТОРИЯ - {0} - frU1={1} frU2={2} frU3={3} frD1={4} frD2={5} frD3={6} ", Bars[Bars.Range.To-frac-i].Time,frU1,frU2,frU3,frD1,frD2,frD3);				  
			  } 			
            i++;
        }			
