...
//====== ВВЕРХУ ПИК =====================================================================================================================
				...
				{ // ВВЕРХУ на SELL - td
					...
					if(zzd6<zzd4 && zzd2<zzd4 && zzd3<zzd5 && nd  && zzd5>nkz4)
						 {  
		var toolPolyLine = Tools.Create<PolyLine>();
			...
			toolPolyLine.Width=4;	
					...
					if (posGuidBuy==Guid.Empty && (zzd1-zzd2)>(zzd3-zzd2)*0.38 && (zzd1-zzd2)<(zzd3-zzd2)*0.81) {  frUp0=frUp;	
...
//==== ВНИЗУ ПИК ======================================================================================================================				
				...
				{ // ВНИЗУ BUY tu
					...
					if(zzd6>zzd4 && zzd2>zzd4 && zzd3>zzd5 && nu && zzd5<nkz4)
					{
		...
		var toolPolyLine = Tools.Create<PolyLine>();
			...
			toolPolyLine.Width=4;		
					...
					if (posGuidSell==Guid.Empty  && (zzd2-zzd1)>(zzd2-zzd3)*0.38 && (zzd2-zzd1)<(zzd2-zzd3)*0.81) {		 frDown0=frDown;
