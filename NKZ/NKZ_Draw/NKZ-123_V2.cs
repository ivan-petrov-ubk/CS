...
{
    [TradeSystem("NKZ-123_V2")]          //copy of "NKZ-123"
    public class ZZ_Ex1 : TradeSystem
    {
        ...
        {	
			...
			if (Instrument.Name == "USDJPY") { NKZ=551;  mgB=105; mgS=205; }
			if (Instrument.Name == "USDCAD") { NKZ=591;  mgB=106; mgS=206; }
...
//===========================================================================      		
		  ...
		  if(n4) {
			...
			if (tu && Bars[ci].Low<nkz2)  nu=true;
			if (td && Bars[ci].High>nkz2) nd=true;
		  }
