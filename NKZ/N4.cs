...
////=================================================================================================================		
			   Print("MAX1");
					...
					mind1=10000.0;
						do { i1++; 
							Print("i2={0} - {1} {2} {3}",i1,Bars[Bars.Range.To-i1].Time.DayOfYear,dy,kd);
  			         		if( Bars[Bars.Range.To-i1].Time.Hour<24 &&  
					 			Bars[Bars.Range.To-i1].Time.Hour>0 && 
					 			Bars[Bars.Range.To-i1].Time.DayOfYear==dy-kd-1 ) 
					     {			
						     if(maxd1<Bars[Bars.Range.To-i1].High) { 
							              	maxd1=Bars[Bars.Range.To-i1].High; 
							 			  	tmaxd1=Bars[Bars.Range.To-i1].Time;  }
						 
						     if(mind1>Bars[Bars.Range.To-i1].Low)  { 
							 				mind1=Bars[Bars.Range.To-i1].Low; 
                			  				tmind1=Bars[Bars.Range.To-i1].Time;  }
					     }
				    } while(Bars[Bars.Range.To-i1].Time.DayOfYear!=(dy-kd-2) && i1<1000);		
			   Print("MAX");					
// Визначення максимума ==============================================================================
					...
					mind=10000.0;
				do { i1++; 
					Print("i1={0} - {1} {2} {3}",i1,Bars[Bars.Range.To-i1].Time.DayOfYear,dy,kd);
  			         if( Bars[Bars.Range.To-i1].Time.Hour<24 &&  
					 Bars[Bars.Range.To-i1].Time.Hour>0 && 
				    ...
				    } while(Bars[Bars.Range.To-i1].Time.DayOfYear!=(dy-kd-1) && i1<10000);	
        }        
//===============================================================================================================================
...
//=== КОРЕКЦИЯ ===========================================================================================================							 
	...
	if(DTime.Hour==01 && DTime.Minute==00) 
        {    i=1; 
