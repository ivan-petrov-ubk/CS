...
namespace IPro.TradeSystems
{
    ...
    public class ZZ_Ex1 : TradeSystem
    {
		...
		[Parameter("frU3 :", DefaultValue = 0)]
        public int fu3 { get; set; }
		[Parameter("frD2 :", DefaultValue = 0)]
        public int fd2 { get; set; }
		[Parameter("frD3 :", DefaultValue = 0)]
        public int fd3 { get; set; }		
        ...
        {	
			...
			frU3 = fu3*Instrument.Point;
			frD2 = fd2*Instrument.Point;
			frD3 = fd3*Instrument.Point;
