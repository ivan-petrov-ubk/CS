...
namespace IPro.TradeSystems
{
	...
	public class StrategyMovingAverage : TradeSystem
    {
        ...
        [Parameter("LR_Period", DefaultValue = 7, MinValue = 1, GroupId = __ui_cGroup_Parameters1)]
        ...
        [Parameter("LR_Method", DefaultValue = MaMethods.Lwma, GroupId = __ui_cGroup_Parameters1)]
        ...
        [Parameter("LR_Period", DefaultValue = 24, MinValue = 1, GroupId = __ui_cGroup_Parameters2)]
        ...
        [Parameter("LR_Method", DefaultValue = MaMethods.Lwma, GroupId = __ui_cGroup_Parameters2)]
        ...
        [Parameter("LR_Lot", DefaultValue = 0.1, IsLot = true, GroupId = __ui_cGroup_Props)]
