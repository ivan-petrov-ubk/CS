    ...
    public class ZigZag2 : TradeSystem
    {
        ...
        protected override void NewBar()
        {
			...
			if(posGuidSell==Guid.Empty) {
			   var result1 = Trade.OpenPendingPosition(Instrument.Id, ExecutionRule.SellLimit, 0.1,  Bars[zzd2].High, 0, Stops.InPips(200,200), null, null, null);
			...
			{   
				...
				var result = Trade.OpenPendingPosition(Instrument.Id, ExecutionRule.BuyLimit, 0.1, Bars[zzd2].Low, 0, Stops.InPips(200,200), null, null, null);
			...
			if (posGuidBuy!=Guid.Empty && Trade.GetPosition(posGuidBuy).State==PositionState.Pending)
				{
					...
					var result1 = Trade.OpenPendingPosition(Instrument.Id, ExecutionRule.BuyLimit, 0.1,  Bars[zzd2].Low, 0, Stops.InPips(200,200), null, null, null);
