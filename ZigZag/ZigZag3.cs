...
{
    [TradeSystem("ZigZag3")] //copy of "ZigZag2"
    public class ZigZag2 : TradeSystem
    {
        ...
        protected override void NewBar()
        {
			...
			if(posGuidSell==Guid.Empty) {
			   var result1 = Trade.OpenPendingPosition(Instrument.Id, ExecutionRule.SellLimit, 1.00,  Bars[zzd1].High, 0, Stops.InPips(200,200), null, null, null);
			...
			if(Bars[zzd2].High<Bars[zzi1].High &&  Bars[zzd2].Low>Bars[zzd1].Low && Bars[zzi1].Low>Bars[zzd1].Low) 
			{
				...
				var result = Trade.OpenPendingPosition(Instrument.Id, ExecutionRule.BuyLimit, 1.00, Bars[zzd1].Low, 0, Stops.InPips(200,200), null, null, null);
			...
			if (posGuidBuy!=Guid.Empty && Trade.GetPosition(posGuidBuy).State==PositionState.Pending)
				{
					...
					var result1 = Trade.OpenPendingPosition(Instrument.Id, ExecutionRule.BuyLimit, 1.00,  Bars[zzd1].Low, 0, Stops.InPips(200,200), null, null, null);
