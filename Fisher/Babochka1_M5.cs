...
{
    [TradeSystem("Babochka1_M5")]     //copy of "Babochka1"
...
#region	GetIndicatorsAndFrames // Get Indicators' references...
        ...
        {
			if(Instrument.Spread>20) return;
...
//=== КОРЕКЦИЯ STOP ===========================================================================================================
			 var posBuy1 = Trade.GetPosition(posGuidBuy);
			var posSell1 = Trade.GetPosition(posGuidSell);
			  if(frUp && posGuidSell!=Guid.Empty && frUpH<(posSell1.OpenPrice+0.00100))   Trade.UpdateMarketPosition(posGuidSell, frUpH+Instrument.Spread, null, null);
			  if(frDown && posGuidBuy!=Guid.Empty && frDownL>(posBuy1.OpenPrice-0.00100))  Trade.UpdateMarketPosition(posGuidBuy, frDownL-Instrument.Spread, null, null);
//=== БЕЗУБЫТОК STOP ===========================================================================================================
	...
	if( L1 && L2 &&  sF<0 &&  _maInd200>_maInd3_1)
			{
				...
				var result = Trade.OpenMarketPosition(Instrument.Id, ExecutionRule.Sell, 0.1, Instrument.Ask, -1, Stops.InPips(100,null), null, null);
	...
	if( H1 && H2 &&  sF>0 && _maInd200<_maInd3_1 )
	   {
				...
				var result = Trade.OpenMarketPosition(Instrument.Id, ExecutionRule.Buy, 0.1, Instrument.Bid, -1, Stops.InPips(100,null), null, null);
