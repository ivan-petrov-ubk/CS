...
namespace IPro.TradeSystems
{
    ...
    public class ZZ_Ex1 : TradeSystem
    {
		...
		[Parameter("Fractal :", DefaultValue = 7, MinValue = 2, MaxValue = 20)]
		public int frac { get;set; }	
		
		[Parameter("Пауза :", DefaultValue = 5, MinValue = 0, MaxValue = 10)]
...
//------------------------------------------------------------------------------------------------------------------------------------			
	...
	if(posGuidBuy!=Guid.Empty)  XXPrint("{0} ----- k={1} kf={2} Buy7={3},Sell7={4} Fs1={5} Fs0={6} FsU={7} FsD={8}  PS={9} {10}",Bars[ci].Time,k,kf, Buy7,Sell7,Fs1,Fs0,FsU,FsD,posActiveMineS.Length,posGuidBuy.ToString());
	if(posGuidSell!=Guid.Empty)	XXPrint("{0} ----- k={1} kf={2} Buy7={3},Sell7={4} Fs1={5} Fs0={6} FsU={7} FsD={8}  PS={9} {10}",Bars[ci].Time,k,kf, Buy7,Sell7,Fs1,Fs0,FsU,FsD,posActiveMineS.Length,posGuidSell.ToString());
	if(posGuidSell==Guid.Empty && posGuidBuy==Guid.Empty)
		                        XXPrint("{0} ----- k={1} kf={2} Buy7={3},Sell7={4} Fs1={5} Fs0={6} FsU={7} FsD={8} PS={9}",Bars[ci].Time,k,kf, Buy7,Sell7,Fs1,Fs0,FsU,FsD,posActiveMineS.Length);
		}		
//===============================================================================================================================   
