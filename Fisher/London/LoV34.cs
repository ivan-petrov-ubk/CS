...
namespace IPro.TradeSystems
{
    ...
    public class ZZ_Ex1 : TradeSystem
    {
		...
		public ISeries<Bar> _barM5;
		private int _lastIndexM5 = -1;
		public Period periodM5;			
...
//==== Торги =========================================================================================================================
			 if ( DTime.Hour<6 ) { torg=true; k=0; tr=false;}  
//==== Торги =========================================================================================================================
	 
	 if ( DTime.Hour==7 && DTime.Minute==5 ) {  Print("{0} - {1}  {2} - {3}",DTime,m5F,tmM1,m1F);
					if (posGuidBuy==Guid.Empty && torg && m5F<-0.3 && m1F<-0.3) {  torg=false;		
					...
					if (posGuidSell==Guid.Empty && torg && m5F>0.3 && m1F>0.3) {	torg=false; 	
...
//======================================================================================================================================		  
		...
		if(posGuidBuy!=Guid.Empty && ( Trade.GetPosition(posGuidBuy).Pips>50 || m15F>-0.3)) tr=true;
		if(posGuidSell!=Guid.Empty && ( Trade.GetPosition(posGuidSell).Pips>50 || m15F<0.3)) tr=true;
