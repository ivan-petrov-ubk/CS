...
{
    [TradeSystem("Paterns1_Buy")]  //copy of "Paterns1"
			...
			if( (m4-m3)/(m4-m5)>=0.13  && (m4-m3)/(m4-m5)<=0.618 && 
				...
				{	    Print("Патерн 5-0 - {0} - {1}",DTime,Instrument.Name); fst=m1;
						var toolPolyLine = Tools.Create<PolyLine>();
							...
							var toolText = Tools.Create<Text>(); toolText.Color=Color.Blue;	toolText.FontSize=14; toolText.Point=new ChartPoint(DTime, Bars[Bars.Range.To-1].High);
