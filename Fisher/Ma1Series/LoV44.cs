...
//======================================================================================================================================		  
		...
		if(posGuidBuy!=Guid.Empty && ( Trade.GetPosition(posGuidBuy).Pips>50 || m5F>-0.3)) tr=true;
		if(posGuidSell!=Guid.Empty && ( Trade.GetPosition(posGuidSell).Pips>50 || m5F<0.3)) tr=true;
