...
{
    [TradeSystem("ZZ_Fisher")]   //copy of "ZZ_Ex4_Fractal"
    public class ZZ_Ex1 : TradeSystem
    {
		...
		public FisherTransformOscillator _ftoInd15;
...
//===============================================================================================================================
              protected override void NewQuote()
        {
			...
			sF = _ftoInd15.FisherSeries[_lastIndexM15];
			sF1 = _ftoInd15.FisherSeries[_lastIndexM15-1];	
			} 
...
//======================================================================================================================================
			...
			{  
				...
				{ // ВВЕРХУ
					...
					if(zzd2>=FU && zzd2>=FD && zzd3<=FD && sF<0)	
						{
				...
				{ // ВНИЗУ
					zzd6=zzd5;zzd5=zzd4;zzd4=zzd3; zzd3=zzd2; zzd2=zzd1; zzd1=zzi2; 
					zzu6=zzu5;zzu5=zzu4;zzu4=zzu3; zzu3=zzu2; zzu2=zzu1; zzu1=zz2;
					if(zzd2>=FD && zzd2>=FU && zzd3<=FU && sF>0)
