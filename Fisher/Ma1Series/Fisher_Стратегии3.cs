...
namespace IPro.TradeSystems
{
    ...
    public class Fisher2 : TradeSystem
    {
        ...
        protected override void NewBar()
        {
			...
			//if ( _ftoInd.FisherSeries[Bars.Range.To-1]>0  && IsF0<0 ) { IsF0 = 1;  Buy();}  // Fisher  пересекает 0 Red
			//if ( _ftoInd.FisherSeries[Bars.Range.To-1]<0  && IsF0>0 ) { IsF0 = -1; Sell();} // Fisher  пересекает 0 Blue
