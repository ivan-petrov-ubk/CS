...
//===============================================================================================================================
			...
			if(sHF>0 && sM15F>0 && frSU>0 && fr_all_Up_L &&  posGuidBuy==Guid.Empty ) { // Print("BUY - sHF={0} - sM15F={1}",sHF, sM15F);
	// Закрываем SellStop
...
//===============================================================================================================================
			...
			if(sHF<0 && sM15F<0 && frSD>0 && fr_all_Down_L && posGuidSell==Guid.Empty) 
			         {    // Закрываем BuyStop 
