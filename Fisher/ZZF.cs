...
{
    [TradeSystem("ZZF")]   //copy of "ZZ_Ex4_Fractal"
...
//======================================================================================================================================
			...
			{  
				...
				{ // ВВЕРХУ
					...
					if(zzd2>=FU && zzd2>=FD && zzd3<=FD && zzu1<zzu3 && zzu1>zzu2+(zzu3-zzu2)*0.382)	
						{
				...
				{ // ВНИЗУ
					zzd6=zzd5;zzd5=zzd4;zzd4=zzd3; zzd3=zzd2; zzd2=zzd1; zzd1=zzi2; 
					zzu6=zzu5;zzu5=zzu4;zzu4=zzu3; zzu3=zzu2; zzu2=zzu1; zzu1=zz2;
					if(zzd2>=FD && zzd2>=FU && zzd3<=FU && zzu1>zzu3  && zzu1<zzu2-(zzu2-zzu3)*0.382)
