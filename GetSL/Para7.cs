...
//=== КОРЕКЦИЯ ===========================================================================================================							 
	 if ( DTime.Hour==6 && DTime.Minute==45 ) { torg7=true; Print("===================     6:45 =============================="); }
	 if ( DTime.Hour==12 && DTime.Minute==00 ) { torg12=true;	Print("===================     11:55 ============================");}
	  	
	 if ( DTime.Hour==11 && DTime.Minute==45 ) { Print("===================     11:40 ==============================");
		  torg7=false;
