...
using System.IO;
// Два индикатора ZZ  - один период 60 другой 3 -  идея: первый дает направление другой точку входа
// Вход происходит при возникновении сигнала о переходе (пик на 60) и тут-же пик на (3) 
// Выход или по СтопЛос или появился сигнал обратный (ПИК на 60 в обратную сторону) 
