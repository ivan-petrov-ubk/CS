...
{
    [Indicator("SlowKAMA", Location = IndicatorLocation.Chart)]
    public class SlowKAMA : Indicator
    {
		
		[Parameter("SP :", DefaultValue = 2.0, MinValue = 2.0)]
		public double SP { get; set; }
		
		[Parameter("FP :", DefaultValue = 30.0, MinValue = 2.0)]
		public double FP { get; set; }
		
		[Parameter("NP :", DefaultValue = 25, MinValue = 3)]
        ...
        [Series("KAMAUp", Color = Color.LimeGreen, Style = SeriesStyle.Chars, CharCode = CharCode.Circle, Width = 1)]
        public IIndicatorSeries KAMAUp { get; set; } 

		[Series("KAMADn", Color = Color.Gold, Style = SeriesStyle.Chars, CharCode = CharCode.Circle, Width = 1)]
