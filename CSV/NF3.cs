...
namespace IPro.TradeSystems
{
    ...
    public class ZZ_Ex1 : TradeSystem
    {
		...
		public bool frU,frD,bu1,bu2,first;
		    ...
		    {   first=false;
				if(tu) { 
					...
					//Print("Zmax={0}",zmax);
			         ...
			         nkz4v= zmax-((NKZ*0.090909)*Instrument.Point); 
				     nkz2v= zmax-(((NKZ*2)*0.090909)*Instrument.Point);
					 ...
					 nkz2v=Math.Round(nkz2v,Instrument.PriceScale); // 1.13233   v=1.13187
					
//Print("TrendLineUp = zmax={0} nkz4v={1} tmax.AddDays(1)={2}",tmax,nkz4v,tmax.AddDays(1));	
...
//Print("TrendLineDw = tmin={0} nkz4v={1} tmin.AddDays(1)={2} zmin={3}",tmin,nkz4v,tmin.AddDays(1),zmin);		
...
//========  END FIRST ============================================================================================================      		
		  if (tu && Bars[ci].High>zmax) 
		  		{ 
			        ...
			        nkz2v=Math.Round(nkz2v,Instrument.PriceScale); 
			 		nd=false; nu=false;
//Print("TrendLineUp = tmax={0} nkz4v={1} tmax.AddDays(1)={2}",tmax,nkz4v,tmax.AddDays(1));	
...
toolText1.Point=new ChartPoint(tmax, nkz2v+Instrument.Spread);toolText1.Caption=string.Format("{0}",nkz2v);				
		  ...
		  if (td && Bars[ci].Low<zmin ) 
		  		{ 
					...
					nd=false; nu=false; 
//Print("TrendLineDw = tmin={0} nkz4v={1} tmin.AddDays(1)={2}",tmin,nkz4v,tmin.AddDays(1));	
