...
{
    [TradeSystem("ZZ_Ex4_FisherH1")]   //copy of "ZZ_Ex4_Fractal"
    public class ZZ_Ex1 : TradeSystem
    {
		[Parameter("ExtDepth:", DefaultValue = 3)]
        public int ED { get; set; }		
		
		private ZigZag _wprInd,_wprIndM15;
		private Guid posGuidBuy=Guid.Empty;
		private Guid posGuidSell=Guid.Empty;
		private double zz1=2,zz2=2,zz3=2,sF,bF,sF1;
		private double m15F,m15F1;
		private double zztb2,zzts2,zzM15;
		...
		public FisherTransformOscillator _ftoInd,_ftoIndH1,_ftoIndM15;
		...
		public ISeries<Bar> _barH1,_barM15;
		public Period periodM15;
		private int _lastIndexH1 = -1,_lastIndexM15 = -1;
		public DateTime tmM15,tmH1;
        ...
        protected override void Init()
        {
			...
			_wprInd= GetIndicator<ZigZag>(Instrument.Id, periodM15);
			_wprInd.ExtDepth=3;
        ...
        protected override void NewQuote()
          {	if (_lastIndexH1 < _barH1.Range.To-1) {
			    ...
			    sF = _ftoIndH1.FisherSeries[_lastIndexH1];
			    //sF1 = _ftoIndH1.FisherSeries[_lastIndexH1-1];
			    tmH1=_barH1[_barH1.Range.To - 1].Time;
		  }		  
		  	if (_lastIndexM15 < _barM15.Range.To-1) {
     		    _lastIndexM15 = _barM15.Range.To - 1;
			    m15F  = _ftoIndM15.FisherSeries[_lastIndexM15];
			 	//m15F1 = _ftoIndM15.FisherSeries[_lastIndexM15];
				if(_wprIndM15.MainIndicatorSeries[_barM15.Range.To-1]>0)
				zzM15 = _wprIndM15.MainIndicatorSeries[_barM15.Range.To-1];
...
//======================================================================================================================================		  
		    ...
		    if(sF>0 && sF>bF) fuH1=true; else fuH1=false;
			if(sF<0 && sF<bF) fdH1=true; else fdH1=false;
