...
//------------------------------------------------------------------------------------------------------------------------------------			
	...
	if(posGuidBuy!=Guid.Empty)  XXPrint("{0} ----- k={1} kf={2} Buy7={3},Sell7={4} Fs1={5} Fs0={6} FsU={7} FsD={8} {9}",Bars[ci].Time,k,kf, Buy7,Sell7,Fs1,Fs0,FsU,FsD,posGuidBuy.ToString());
	if(posGuidSell!=Guid.Empty)	XXPrint("{0} ----- k={1} kf={2} Buy7={3},Sell7={4} Fs1={5} Fs0={6} FsU={7} FsD={8} {9}",Bars[ci].Time,k,kf, Buy7,Sell7,Fs1,Fs0,FsU,FsD,posGuidSell.ToString());
	if(posGuidSell==Guid.Empty && posGuidBuy==Guid.Empty)
		                        XXPrint("{0} ----- k={1} kf={2} Buy7={3},Sell7={4} Fs1={5} Fs0={6} FsU={7} FsD={8}",Bars[ci].Time,k,kf, Buy7,Sell7,Fs1,Fs0,FsU,FsD);
		}		
//===============================================================================================================================   
