...
{
    [TradeSystem("ZZ_5Volna")]    //copy of "ZZ_Golova_Plechi"
...
var result2 = Trade.OpenMarketPosition(Instrument.Id, ExecutionRule.Buy, 0.1,Instrument.Bid, -1, Stops.InPips(200,100), null, null);									   
...
//						 if (result1.IsSuccessful) posGuidSell=result1.Position.Id; //Stops.InPips(200,100) Stops.InPrice(Bars[zzd1].High,Bars[Bars.Range.To-1].Low-0.001)
...
var result1 = Trade.OpenMarketPosition(Instrument.Id, ExecutionRule.Sell, 0.1,Instrument.Ask, -1,Stops.InPips(200,100), null, null);					
//var result2 = Trade.OpenMarketPosition(Instrument.Id, ExecutionRule.Buy, 0.1,Instrument.Bid, -1, Stops.InPrice(Bars[zzd1].Low,null), null, null);		
						// if (result2.IsSuccessful) posGuidBuy=result2.Position.Id; //Stops.InPips(200,100)  Stops.InPrice(Bars[zzd1].Low,Bars[Bars.Range.To-1].High+0.001),
