...
//==== ВНИЗУ ПИК ======================================================================================================================
			...
			if(Bars[Bars.Range.To-1].Close>zzu && Bars[Bars.Range.To-2].High>zzu) {
			...
			if(Bars[Bars.Range.To-1].Close<zzd && Bars[Bars.Range.To-2].Low<zzd) {
			...
			if(ibuy>ED && posGuidBuy!=Guid.Empty) {var res1 = Trade.CloseMarketPosition(posGuidBuy); if (res1.IsSuccessful) {posGuidBuy = Guid.Empty; ibuy=0;}}
			if(isell>ED && posGuidSell!=Guid.Empty) {var res2 = Trade.CloseMarketPosition(posGuidSell); if (res2.IsSuccessful) {posGuidSell = Guid.Empty; isell=0;}}
