...
//======================================================================================================================================
			...
			{  
				...
				{ // ВВЕРХУ
					...
					//if(zzu4>zzu6 && zzu4>zzu2 && zzu6>zzu5 && zzu4>zzu3 && zzu2>zzu3 && zzu4>zzu5 && zzu3>zzu5 && zzu2>zzu3)
					if(zzu3>zzu5 && zzu3>zzu1 && zzu4>zzu6 )
						{var vr=Tools.Create<VerticalLine>(); vr.Color=Color.Red; vr.Time=Bars[zzd3].Time; vr.Width=4;
						 //if(posGuidSell==Guid.Empty){
							//var result1 = Trade.OpenPendingPosition(Instrument.Id, ExecutionRule.SellStop, 0.1,  zzu1, 0, Stops.InPips(200,100), null, null, null);
				...
				{ // ВНИЗУ
					...
					//if(zzu6>zzu4 && zzu4>zzu5 && zzu4>zzu2 && zzu2>zzu3 && zzu1>zzu3 && zzu2>zzu1)
					...
					{var vr=Tools.Create<VerticalLine>(); vr.Color=Color.Blue; vr.Time=Bars[zzd3].Time; vr.Width=4;
						...
						// var result = Trade.OpenPendingPosition(Instrument.Id, ExecutionRule.BuyStop, 0.1, zzu2, 0, Stops.InPips(200,100), null, null, null);	
