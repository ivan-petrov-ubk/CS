...
{
    [TradeSystem("ZigZag4")]  //copy of "ZigZag3"
    public class ZigZag2 : TradeSystem
    {
        ...
        protected override void NewBar()
        {
			...
			if(Bars[zzd1].Close<_wprInd.MainIndicatorSeries[zzd1] && Bars[zzd2].Low>Bars[zzi1].Low &&  Bars[zzd2].High<Bars[zzd1].High && Bars[zzi1].High<Bars[zzd1].High) 
			{  Print("{0} -- {1}   ---  ",Bars[zzd1].Close<_wprInd.MainIndicatorSeries[zzd1],Bars[zzd1].Time,Bars[zzd1].Close,_wprInd.MainIndicatorSeries[zzd1]);
			...
			if(Bars[zzd1].Close>_wprInd.MainIndicatorSeries[zzd1] && Bars[zzd2].High<Bars[zzi1].High &&  Bars[zzd2].Low>Bars[zzd1].Low && Bars[zzi1].Low>Bars[zzd1].Low) 
			{Print("{0} -- {1}",Bars[zzd1].Close>_wprInd.MainIndicatorSeries[zzd1],Bars[zzd1].Time,_wprInd.MainIndicatorSeries[zzd1]);
				var toolVerticalLine=Tools.Create<VerticalLine>();
...
if(Bars[zzd1].Close>_wprInd.MainIndicatorSeries[zzd1] && zz3>zz2 && zz2<zz1 && up)  { up=false; zzd3=zzd2; zzd2=zzd1; zzd1=zzi2; zzU=_wprInd.MainIndicatorSeries[zzd1];
//Print("zzU={0} Bars[zzd1]={1} -- {2} -- {3}",zzU,Bars[zzd1].Close,Bars[zzd1].Time,Bars[zzd1].Close<zzU);
}	
if(Bars[zzd1].Close>_wprInd.MainIndicatorSeries[zzd1] && zz3<zz2 && zz2>zz1 && !up) { up=true;  zzd3=zzd2; zzd2=zzd1; zzd1=zzi2; zzD=_wprInd.MainIndicatorSeries[zzd1];
