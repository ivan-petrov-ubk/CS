...
{
    [TradeSystem("ZZ_Ex3_MA_SL")]    //copy of "ZZ_Ex3_MA"
    public class ZZ_Ex1 : TradeSystem
    {
		...
		private double zztb2,zzts2,ss=2.0,sb=2.0,sls=2.0,slb=2.0;
...
//======================================================================================================================================		  
		  	 if(Bars[Bars.Range.To-1].Open<slb && posGuidBuy!=Guid.Empty){  slb=2.0;	
					var res = Trade.CloseMarketPosition(posGuidBuy);
			     	   			if (res.IsSuccessful)  posGuidBuy = Guid.Empty; 
						} 
			 if(Bars[Bars.Range.To-1].Open>sls && posGuidSell==Guid.Empty){ sls=2.0;
...
//======================================================================================================================================
			...
			{  
				...
				{ // ВВЕРХУ
					...
					if(posGuidSell!=Guid.Empty){ sls=zz2; }	
				...
				{ // ВНИЗУ
					...
					if(posGuidBuy!=Guid.Empty){ slb=zz2; }	
