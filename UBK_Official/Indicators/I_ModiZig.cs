...
{
    [Indicator("ModiZig", Location = IndicatorLocation.Chart)]
    public class ModiZig : Indicator
    {
        [Series("MZ", Color = Color.Blue, Style = SeriesStyle.ContinuousLine, Width = 1)] //Style = SeriesStyle.Line
