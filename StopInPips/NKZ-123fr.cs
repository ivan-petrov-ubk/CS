...
{
    [TradeSystem("NKZ-123fr")]          //copy of "NKZ-123"
    public class ZZ_Ex1 : TradeSystem
    {
		...
		private int    zzt1,zzt2,zzt3,zzt4,zzt5,zzt6,zzt7;
...
//===========================================================================			
		  ...
		  { 
			...
			//== Касание зоны/1\4 ===============================
			for (int i=ci; i>iFT; i--) {  
			if (tu && Bars[i].Low<nkz4) nu=true;
			if (td && Bars[i].High>nkz4) nd=true;
			}
				...
				{ // ВНИЗУ
					...
					zzd7=zzd6; zzd6=zzd5; zzd5=zzd4; zzd4=zzd3; zzd3=zzd2; zzd2=zzd1; zzd1=zz2;
					    // if( zzd3>zzd5 && zzd3>zzd1 &&  zzd5>zzd1 && nd)//  ВНИЗУ
					     if( zzd3>zzd5 && zzd3>zzd1 &&  zzd5>zzd7 && nd)
					{
