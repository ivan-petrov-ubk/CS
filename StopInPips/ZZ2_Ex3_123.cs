...
namespace IPro.TradeSystems
{
    ...
    public class ZZ_Ex1 : TradeSystem
    {
		...
		private bool torg=true,torg2=true;
...
//=== Закрытие всех ордеров если пятница 16:00 (19:00 Kiev) ===========================================================================
		  ...
		  { z50_3=0;z50_2=0;z50_1=0; torg=false;
			...
			Print("{0} - DayOfWeek={1} Hours={2} {3} {4}",Bars[Bars.Range.To-1].Time,Bars[Bars.Range.To-1].Time.DayOfWeek,Bars[Bars.Range.To-1].Time.Hour,Bars[Bars.Range.To-1].Time.DayOfWeek==DayOfWeek.Friday,Bars[Bars.Range.To-1].Time.Hour==16);
		  ...
		  if( _wprInd50.MainIndicatorSeries[Bars.Range.To-1]>0) 
			{ vb.Time=Bars[Bars.Range.To-1].Time;
			   ...
			   z50_1 =_wprInd50.MainIndicatorSeries[Bars.Range.To-1];
				if (z50_3<z50_2 && z50_1<z50_2) { torg2=true;
...
//====== ВВЕРХУ ПИК =====================================================================================================================
		...
		var toolPolyLine = Tools.Create<PolyLine>();
			...
			toolPolyLine.Width=4;	
							...
							if(z50_1<z50_2 && torg && torg2) {
							if(torg && posGuidSell==Guid.Empty){ torg2=false;
		...
		var toolPolyLine = Tools.Create<PolyLine>();
			...
			toolPolyLine.Width=4;				
							...
							toolPolyLine.AddPoint(new ChartPoint(Bars[zzd1].Time, Bars[zzd1].Low));
									...
									if(z50_1>z50_2 && torg && torg2) {
							if(torg && posGuidBuy==Guid.Empty){ torg2=false;
