...
{
    [TradeSystem("Lo700")]         //copy of "Lo1"
    public class ZZ_Ex1 : TradeSystem
    {
		[Parameter("Версия", DefaultValue = "22.05.2018 London 7:00")]
...
//=========  Рисуем линию  начала торгов Европы =============================================================================			
			if ( DTime.Hour==6 && DTime.Minute==00 ) 
			{  var vl1 = Tools.Create<VerticalLine>(); vl1.Time=Bars[Bars.Range.To-1].Time.AddHours(1); vl1.Color=Color.Aqua; 	}
		
			if ( DTime.Hour==7 && DTime.Minute==00 ) torg=true; 
			if ( DTime.Hour<7) torg=false; 	
