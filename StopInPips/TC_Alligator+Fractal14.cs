...
// =================================================================================================================================				 
			...
			if (Bars[Bars.Range.To-1].Time.Hour==9 && Bars[Bars.Range.To-1].Time.Minute==00) Torg=false;
		 ...
		 // if ( DTime.Hour==6 && DTime.Minute==0 ) 
          //{  // 1. Измеряем высоту диапазона в промежутке с 9 до 18 часов по GMT.
			 ...
			 // 2. После 18:00 выставляем 2 ордера: Buy Limit и Sell Limit на расстоянии Х пунктов от текущей цены.
			   var x=Math.Round((highestPrice-lowestPrice),5);
		       var xp=(int)(x*100000);
