...
{
    [TradeSystem("NZ002_v7")]                //copy of "NZ001_v5"
    public class ZZ_Ex1 : TradeSystem
    {
		...
		[Parameter("File :", DefaultValue = @"nkz")]
		...
		public bool frU,frD,tu,td,nu,nd,n2,zp;
		public double fr1,fr2,dt1,TP2;
        ...
        {	_frInd = GetIndicator<Fractals>(Instrument.Id, Timeframe);	
			...
			Print("LogFile={0}",trueLogPath);
			InitFile();	
			
			XXPrint("Init | {0} | NKZ={1} tu={2} td={3} nu={4} nd={5} n2={6} dt1={7} fr1={8} fr2={9} TP2={10} SL1={11} dl={12} frac={13} kof={14} Lot={15}",
	              				Bars[Bars.Range.To].Time,NKZ,tu,td,nu,nd,n2,dt1,fr1,fr2,TP2,SL1,dl,frac,kof,lot);
...
//===============================================================================================================================   
		...
		{
			//trueInitPath=PathToLogFile+"\\nkz.txt";
		 	trueInitPath=PathToLogFile+"\\"+LogFileName+".txt";
    ...
    {   st="";
			...
			for (int j = 0; j < line.Length; j++)
				{    
					...
					if(zp) {	
						...
						if(k==6) { if(st=="1") n2=true; else n2=false; }
		...
		Print("INIT name={0} - NKZ={2} nkz4={1} st={3} fr1={4} fr2={5} ",name,dt1,NKZ,st,fr1,fr2);
    }  
