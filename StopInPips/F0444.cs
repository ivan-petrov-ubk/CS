...
//====================================================================================================================================
					if (posGuidSell!=Guid.Empty) Trade.GetPosition(posGuidBuy).Id.ToString();
	Print("{0} - torg={1} Buy={2} Sell={3} FsU={4} FsD={5} Buy={6} Sell={7}",Bars[Bars.Range.To-1].Time,torg,Buy7,Sell7,FsU,FsD,
					Trade.GetPosition(posGuidBuy).Id.ToString(),Trade.GetPosition(posGuidSell).Id.ToString());
		}		
//===============================================================================================================================   
