...
{
    [TradeSystem("N10-Active")]       //copy of "N9"
...
//=== Торговля ====================================================================		
					...
					if (posGuidBuy==Guid.Empty && tu && FsU && nu && Bars[ci].Low>nkz2 && Bars[ci].Low<frDown) { 		
					...
					if (posGuidSell==Guid.Empty && td && FsD && nd && Bars[ci].High<nkz2 && Bars[ci].High>frUp) {		
