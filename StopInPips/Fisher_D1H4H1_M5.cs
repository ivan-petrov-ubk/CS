    ...
    public class ZZ_Ex1 : TradeSystem
    {
        ...
        protected override void NewQuote()
        {
				if (_lastIndexH1 < _barH1.Range.To-1) {
					if(_lastIndexH1>0 && 
						 _ftoIndH1.FisherSeries[_barH1.Range.To-1]>_ftoIndH1.Ma1Series[_barH1.Range.To-1]) F1U=true; else F1U=false;
					if(_lastIndexH1>0 && 
						 _ftoIndH1.FisherSeries[_barH1.Range.To-1]<_ftoIndH1.Ma1Series[_barH1.Range.To-1]) F1D=true; else F1D=false;
