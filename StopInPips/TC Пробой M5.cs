...
namespace IPro.TradeSystems
{
    ...
    public class TC_Пробой_M5 : TradeSystem
    {
		...
		public bool F1U,LogD,LogU,torg,isFMU,isFMD;
        ...
        protected override void NewQuote()
        {
           if (_lastIndexH1 < _barH1.Range.To-1) {
			...
			Print("{0} - {1} {2} - {3} {4}",_barH1[_barH1.Range.To-1].Time,_ftoIndH1.FisherSeries[_barH1.Range.To-1],_ftoIndH1.Ma1Series[_barH1.Range.To-1],isFMU,isFMD);	
		   }
        }
...
//======================================================================================================================================
		  if (torg && LogU && _ftoInd.FisherSeries[Bars.Range.To-1]>0 &&  _ftoInd.FisherSeries[Bars.Range.To-2]<0 ) {		   
				LogU=false;
...
//======================================================================================================================================		  
		  if (torg && LogD && _ftoInd.FisherSeries[Bars.Range.To-1]<0 &&  _ftoInd.FisherSeries[Bars.Range.To-2]>0 ) {			 
			  	LogD=false;  
